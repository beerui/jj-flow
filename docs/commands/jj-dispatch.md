...
生成位置为 `.workflow/tasks/TASK-DEL-xxx/任务.md`、`plan.md`、`progress.md` 和 `result.md`。只有明确的 `quick` 任务可以跳过。handoff、dispatch、报告和 receipts 同样按任务 ID 分目录，避免平铺大量 JSON/Markdown。
