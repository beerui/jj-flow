...
const requiredFiles = [
  ...
  '.codex/skills/jj-same/references/artifact-routing.md',
  ...
  '.codex/skills/jj-same/scripts/collect-port-evidence.mjs',
  '.codex/skills/jj-same/scripts/collect-port-evidence.sh',
  '.codex/skills/jj-same/scripts/collect-port-evidence.ps1',
  '.codex/skills/jj-same/scripts/extract_session_evidence.py',
  '.codex/skills/jj-same/scripts/README.md',
