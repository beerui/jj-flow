...
const requiredFiles = [
  ...
  'agents/jj-implementer.md',
  'agents/jj-reviewer.md',
  'agents/jj-researcher.md',
  'agents/jj-implementer.toml',
  'agents/jj-reviewer.toml',
  'agents/jj-researcher.toml',
  ...
  'skills/jj-dispatch/references/claude-dispatch-execution.md',
  'src/claudeHostAdapter.mjs',
  'tests/claude-host-adapter.test.mjs',
