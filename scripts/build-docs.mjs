...
const DEEP_PAGES = [
  ...
  { title: 'Ralph 工作区 P2+ lite 执行', source: 'docs/exec-plans/active/2026-09-03-ralph-plans-workspace-p2-lite.md', output: 'exec-plans/active/2026-09-03-ralph-plans-workspace-p2-lite.html', group: '执行计划' },
