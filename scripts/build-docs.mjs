...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    pages: [
      ...
      { title: 'Grok dispatch Mode S 执行', source: 'docs/exec-plans/active/2026-07-30-grok-dispatch-execution.md', output: 'exec-plans/active/2026-07-30-grok-dispatch-execution.html' },
      { title: 'Dispatch / Ralph 任务回退', source: 'docs/exec-plans/active/2026-07-31-dispatch-ralph-rollback.md', output: 'exec-plans/active/2026-07-31-dispatch-ralph-rollback.html' },
      { title: 'Dispatch / Mode S 升级 backlog', source: 'docs/exec-plans/active/2026-07-31-dispatch-upgrade-backlog.md', output: 'exec-plans/active/2026-07-31-dispatch-upgrade-backlog.html' },
      { title: 'Grok Host Adapter Phase 1', source: 'docs/exec-plans/completed/2026-07-27-grok-host-adapter.md', output: 'exec-plans/completed/2026-07-27-grok-host-adapter.html' },
