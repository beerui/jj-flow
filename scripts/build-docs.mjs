...
const DEEP_PAGES = [
  ...
  { title: 'Ralph 工作区 P1 执行', source: 'docs/exec-plans/active/2026-09-02-ralph-plans-workspace-p1.md', output: 'exec-plans/active/2026-09-02-ralph-plans-workspace-p1.html', group: '执行计划' },
