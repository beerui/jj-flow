...
const DEEP_PAGES = [
  ...
  { title: 'Ralph 自动结案', source: 'docs/design-docs/ralph-auto-closeout.md', output: 'design-docs/ralph-auto-closeout.html', group: '设计文档' },
  ...
  { title: 'Ralph 自动结案执行', source: 'docs/exec-plans/completed/2026-09-04-ralph-auto-closeout.md', output: 'exec-plans/completed/2026-09-04-ralph-auto-closeout.html', group: '执行计划' },
