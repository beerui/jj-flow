...
jj-team-coordinate (team-coordinate protocol) does NOT have a static pipeline. All pipelines are generated at runtime from task-analysis.json based on the user's task description.
