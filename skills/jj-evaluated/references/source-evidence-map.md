...
## 2026-08-03 dispatch stale master base (shang-tag-color → carry target / 承载)
...
| report | `docs/evaluations/EP-20260803-dispatch-stale-master-branch-report.md` (jj-flow repo does not write `.workflow/`) |
