...
- ANALYZE: may draft in `analyze.md`; map node optionally `active`.
...
2. On hit, open `.workflow/ralph/RALPH-*/run.json`, `progress.md`, `acceptance.md` via `run_refs`.
