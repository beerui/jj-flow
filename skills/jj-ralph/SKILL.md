...
→ append progress.md
→ 大功能: 改动摘要 → 派遣reviewer审查改动代码 → ASSIGNMENT-REVIEW spawn → [OK]/[WARN] → 用户验收 → MUST finalize (completed/ + index.md)
```
