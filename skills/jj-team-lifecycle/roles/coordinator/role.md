...
Orchestrate jj-team-lifecycle (fixed SDLC): analyze -> dispatch -> spawn -> monitor -> report.
...
1. Resolve workspace paths (MUST do first):
   ...
   - `skill_root` = resolve multi-host (never hardcode only `.claude/skills/team-lifecycle-v4`):
     1. Directory containing this skill's `SKILL.md`
     2. Repo: `skills/jj-team-lifecycle/`
     3. Host: `~/.claude|/.codex|/.grok|/.qoder/skills/jj-team-lifecycle`
     4. Legacy read-only: `…/skills/team-lifecycle-v4`
