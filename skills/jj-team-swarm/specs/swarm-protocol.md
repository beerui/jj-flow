...
Defines how the SKILL.md coordinator (`jj-team-swarm` / team-adversarial-swarm), Python ACO controller, and modular Workflow scripts (or host agent-module fallback) interface.
