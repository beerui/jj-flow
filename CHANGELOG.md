...
- **Ralph 工作区 P2+ lite exec-plan 关闭**：`docs/exec-plans/completed/2026-09-03-ralph-plans-workspace-p2-lite.md`（P2+a + P2+b 勾完并附验收证据）；设计 [Ralph 任务工作区 `.plans` 化改造](docs/design-docs/ralph-plans-workspace.md) §3.8 / §4 P2+ 标落地，整体标 Implemented。
...
## [0.2.0](https://github.com/beerui/jj-flow/compare/jj-flow-v0.1.0...jj-flow-v0.2.0) (2026-09-03)
