...
- **Ralph 工作区 P2+ lite exec-plan**：`docs/exec-plans/active/2026-09-03-ralph-plans-workspace-p2-lite.md`。BRIEF→DELIVER→CLOSE；`--lite` 显式覆写；升 full 同目录；schema 不升 1.3。尚未实现。
